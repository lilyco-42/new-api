...
var channelAffinityTestKeySequence uint64

func uniqueChannelAffinityTestIdentity(t *testing.T) (ruleName, keyFingerprint string) {
	t.Helper()
	sequence := atomic.AddUint64(&channelAffinityTestKeySequence, 1)
	return fmt.Sprintf("rule_%d", sequence), fmt.Sprintf("fp_%d", sequence)
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName, keyFP := uniqueChannelAffinityTestIdentity(t)
	usingGroup := "default"
